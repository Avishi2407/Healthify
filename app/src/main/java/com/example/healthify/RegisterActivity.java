                ...
                if(username.length()==0 || email.length() == 0 || password.length() == 0 || confirm.length() == 0){
                    ...
                    if(password.compareTo(confirm) == 0){
                         if(isValid(password)){
                             ...
                             Toast.makeText(getApplicationContext(), "Record Insterted", Toast.LENGTH_SHORT).show();
                             startActivity(new Intent(RegisterActivity.this, LoginActivity.class));

                          }
                          else{
                              Toast.makeText(getApplicationContext(), "Please enter a valid password (Letter, Digit, Special symbol)",Toast.LENGTH_SHORT).show();
                          }
                          }
                    else{
